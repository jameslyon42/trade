...
Vue.component('main-app', __webpack_require__(37));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__security_Search_vue__ = __webpack_require__(39);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__security_Search_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__security_Search_vue__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
	...
	components: {
		SecuritySearch: __WEBPACK_IMPORTED_MODULE_0__security_Search_vue___default.a
	},
	methods: {
		selected: function selected(security_id) {
			axios.get('/security/' + security_id).then(function (response) {
...
Component.options.__file = "resources/assets/js/components/security/Search.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {  return key !== "default" && key.substr(0, 2) !== "__"})) {  console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-9afc79a0", Component.options)
  } else {
    hotAPI.reload("data-v-9afc79a0", Component.options)
' + '  }
  module.hot.dispose(function (data) {
    disposed = true
  })
	...
	methods: {
		search: function search() {
			...
			axios.get('/security/search', {
				...
				var securities = response.data;
				self.securities = securities;
			});
		},
		highlightSearch: function highlightSearch(value, searchText) {
			if (!value) return '';
		...
		select: function select(security) {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-9afc79a0", module.exports)
  }
}
  ...
  return _c(
    ...
    [
      _c("security-search", {
        ...
        model: {
          value: _vm.security_search,
          callback: function($$v) {
            _vm.security_search = $$v
          },
          expression: "security_search"
        }
      })
    ],
    1
